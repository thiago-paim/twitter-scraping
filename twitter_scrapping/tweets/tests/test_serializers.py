...
class SnscrapeTweetSerializerTest(TestCase):
    ...
    def test_update_tweet_only(self):
        ...
        self.assertEqual(tweet.in_reply_to_id, self.tweet1_updated_tweet.inReplyToTweetId)
        self.assertEqual(tweet.conversation_id, str(self.tweet1_updated_tweet.conversationId))
    ...
    def test_update_user_only(self):
        ...
        self.assertEqual(user.followers_count, self.tweet1_updated_user.user.followersCount)
        self.assertEqual(user.following_count, self.tweet1_updated_user.user.friendsCount)
    ...
    def test_update_tweet_and_user(self):
        ...
        self.assertEqual(user.followers_count, self.tweet1_updated_both.user.followersCount)
        self.assertEqual(user.following_count, self.tweet1_updated_both.user.friendsCount)
